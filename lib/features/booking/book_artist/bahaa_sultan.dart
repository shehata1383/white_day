...
class BahaaSultan extends StatelessWidget {
  const BahaaSultan({super.key});
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            .spaceEvenly,
              children: [
                Image.asset(Images.bahaaSultan1,height: 200.h,fit: BoxFit.fitWidth,),
                Image.asset(Images.bahaaSultan2,height: 200.h,fit: BoxFit.fitWidth,),
              ],
            ),
              ...
              _buildDetailsList(),
               const Divider(color: Colors.grey, thickness: 1),
                  ...
                  const _SectionTitle(title: "About Bahaa Sultan "),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 5.h),
                    child: Text(
"Bahaa Sultan is an Egyptian singer known for his smooth, romantic voice and emotional style, making him a perfect choice for weddings and special events.",                      textAlign: TextAlign.left,
                      style: GoogleFonts.inriaSerif(
                        fontSize: 16.sp,
                        height: 1.4,
