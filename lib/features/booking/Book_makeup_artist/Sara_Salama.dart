...
class SaraSalama extends StatelessWidget {
  const SaraSalama({super.key});
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                const _SectionTitle(title: "About Sara"),
                Padding(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/Sara_Salama/Sara_Salama_1.png'),
          fit: BoxFit.cover,
        ),
      ),
    );
