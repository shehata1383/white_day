...
class YasminAhmed extends StatelessWidget {
  const YasminAhmed({super.key});
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                const _SectionTitle(title: "About Yasmin"),
                Padding(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/Yasmin_Ahmed/YasminAhmed_1.png'),
          fit: BoxFit.cover,
        ),
      ),
    );
