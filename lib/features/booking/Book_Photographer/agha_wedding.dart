...
class AghaWedding extends StatelessWidget {
  const AghaWedding({super.key});
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                _buildDetailsList(),
                const Divider(color: Colors.grey, thickness: 1),
                const _SectionTitle(title: "About Agha"),
                Padding(
