...
class VeletBurgundy extends StatelessWidget {
  const VeletBurgundy({super.key});
            ...
            child: Container(
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(Images.velet1),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Expanded(
            child: Container(
              decoration: const BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(12)),
                image: DecorationImage(
                  image: AssetImage(Images.velet2),
                  fit: BoxFit.cover,
                ),
              ),
            ),
  ...
  Widget _buildImagesGrid() {
    List<String> workImages = [Images.velet3, Images.velet4];
