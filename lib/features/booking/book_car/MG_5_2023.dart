...
class Mg52023 extends StatelessWidget {
  const Mg52023({super.key});
          ...
          child: Column(
            ...
            .center,
              children: [
                Column(
                  children: [
                    Image.asset(Images.mg520231,height: 100.h,fit: BoxFit.fitWidth,),
                    Image.asset(Images.mg520232,height: 100.h,fit: BoxFit.fitWidth,),
                  ],
                ),
                Image.asset(Images.mg520233,height: 200.h,fit: BoxFit.fitWidth,),
              ],
            ),
              ...
              _buildDetailsList(),
               const Divider(color: Colors.grey, thickness: 1),
                  ...
                  Padding(
                    ...
                    child: Text(
"A practical and affordable sedan with modern design, comfortable interior.",                      textAlign: TextAlign.left,
                      style: GoogleFonts.inriaSerif(
                        fontSize: 16.sp,
                        height: 1.4,
