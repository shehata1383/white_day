...
class HyundaiElantra2026 extends StatelessWidget {
  const HyundaiElantra2026({super.key});
          ...
          child: Column(
            ...
            .center,
              children: [
                Column(
                  children: [
                    Image.asset(Images.hyundaiElantra20261,height: 100.h,fit: BoxFit.fitWidth,),
                    Image.asset(Images.hyundaiElantra20262,height: 100.h,fit: BoxFit.fitWidth,),
                  ],
                ),
                Image.asset(Images.hyundaiElantra20263,height: 200.h,fit: BoxFit.fitWidth,),
              ],
            ),
              ...
              _buildDetailsList(),
               const Divider(color: Colors.grey, thickness: 1),
                  ...
                  Padding(
                    ...
                    child: Text(
"It combines elegant design and practical performance at an affordable price.",                      textAlign: TextAlign.left,
                      style: GoogleFonts.inriaSerif(
                        fontSize: 16.sp,
                        height: 1.4,
                  ...
                  const _SectionTitle(title: "5,0 Rating"),
                  Text(
                    "Based on 95 reviews",
                    style: GoogleFonts.inriaSerif(
                      fontSize: 20.sp,
