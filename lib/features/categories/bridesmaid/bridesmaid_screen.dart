...
import '../../../core/model/bridesmaid/model_bridesmaid.dart';
import '../../widget/appbar_logo_screen.dart';
import 'book_bridesmaid/booking_bridesmaid.dart';

class BridesmaidScreen extends StatelessWidget {
  BridesmaidScreen({super.key});
  ModelBridesmaid data = ModelBridesmaid(
    name: "Bridesmaid",
    listImage: [
                  Images.bridesmaid1,
                  Images.bridesmaid2,
    ...
    price: 5000,
    details:  [
      "Attending to the bride all day",
      "Fixing dress,veil,and makeup",
      "Calming nerves and offering support",
      "Coordinating schedules",
      "Handling any last-minute issues",
    ],
    about:                   "Your bridesmaid will be by your side all day, ensuring you look flawless and feel clam. she'll handle any problem that arises, so you can focus on celebrating.",
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const _SectionTitle(title: "About Bridesmaid"),
              Padding(
...
data.about,                  textAlign: TextAlign.left,
              ...
              ElevatedButton(
                onPressed: () {
                  Get.to(()=>BookingBridesmaid(listImage:data.listImage, title: data.name,));
                },
