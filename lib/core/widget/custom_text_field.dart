...
class CustomTextFieldState extends State<CustomTextField> {
  ...
  String? errorMessage(String str) {
   if (widget.hintText == "Password".tr) {
      ...
      else if (widget.hintText == "Section:".tr) {
      return "sectionRequired".tr;
    }
      else if (widget.hintText == "Price:".tr) {
      ...
      else if (widget.hintText == "Year:".tr) {
      return "detailsRequired".tr;
    }
      else if (widget.hintText == "Notes:".tr) {
      return "detailsRequired".tr;
    }
      else if (widget.hintText == "Type of car:".tr) {
      return "detailsRequired".tr;
    }
